...
class rkv_i2c_virtual_sequencer extends uvm_sequencer;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if(!uvm_config_db #(virtual lvc_apb_if)::get(this, "", "apb_if", apb_if)) begin
      `uvm_error("build_phase", "Unable to get apb_if from uvm_config_db")
    end
    vif = cfg.vif;
    rgm = cfg.rgm;
  endfunction
