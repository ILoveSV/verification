...
class ral_reg_i2c_IC_CON extends uvm_reg;
	...
	function new(string name = "i2c_IC_CON");
   ...
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CON)

endclass : ral_reg_i2c_IC_CON


class ral_reg_i2c_IC_TAR extends uvm_reg;
	...
	function new(string name = "i2c_IC_TAR");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_TAR)

endclass : ral_reg_i2c_IC_TAR


class ral_reg_i2c_IC_SAR extends uvm_reg;
	rand uvm_reg_field IC_SAR;
	uvm_reg_field RSVD_IC_SAR;

	function new(string name = "i2c_IC_SAR");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_SAR)

endclass : ral_reg_i2c_IC_SAR


class ral_reg_i2c_IC_HS_MADDR extends uvm_reg;
	rand uvm_reg_field IC_HS_MAR;
	uvm_reg_field RSVD_IC_HS_MAR;

	function new(string name = "i2c_IC_HS_MADDR");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_HS_MADDR)

endclass : ral_reg_i2c_IC_HS_MADDR


class ral_reg_i2c_IC_DATA_CMD extends uvm_reg;
	...
	function new(string name = "i2c_IC_DATA_CMD");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_DATA_CMD)

endclass : ral_reg_i2c_IC_DATA_CMD


class ral_reg_i2c_IC_SS_SCL_HCNT extends uvm_reg;
	rand uvm_reg_field IC_SS_SCL_HCNT;
	uvm_reg_field RSVD_IC_SS_SCL_HIGH_COUNT;

	function new(string name = "i2c_IC_SS_SCL_HCNT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_SS_SCL_HCNT)

endclass : ral_reg_i2c_IC_SS_SCL_HCNT


class ral_reg_i2c_IC_SS_SCL_LCNT extends uvm_reg;
	rand uvm_reg_field IC_SS_SCL_LCNT;
	uvm_reg_field RSVD_IC_SS_SCL_LOW_COUNT;

	function new(string name = "i2c_IC_SS_SCL_LCNT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_SS_SCL_LCNT)

endclass : ral_reg_i2c_IC_SS_SCL_LCNT


class ral_reg_i2c_IC_FS_SCL_HCNT extends uvm_reg;
	rand uvm_reg_field IC_FS_SCL_HCNT;
	uvm_reg_field RSVD_IC_FS_SCL_HCNT;

	function new(string name = "i2c_IC_FS_SCL_HCNT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_FS_SCL_HCNT)

endclass : ral_reg_i2c_IC_FS_SCL_HCNT


class ral_reg_i2c_IC_FS_SCL_LCNT extends uvm_reg;
	rand uvm_reg_field IC_FS_SCL_LCNT;
	uvm_reg_field RSVD_IC_FS_SCL_LCNT;

	function new(string name = "i2c_IC_FS_SCL_LCNT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_FS_SCL_LCNT)

endclass : ral_reg_i2c_IC_FS_SCL_LCNT


class ral_reg_i2c_IC_HS_SCL_HCNT extends uvm_reg;
	rand uvm_reg_field IC_HS_SCL_HCNT;
	uvm_reg_field RSVD_IC_HS_SCL_HCNT;

	function new(string name = "i2c_IC_HS_SCL_HCNT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_HS_SCL_HCNT)

endclass : ral_reg_i2c_IC_HS_SCL_HCNT


class ral_reg_i2c_IC_HS_SCL_LCNT extends uvm_reg;
	rand uvm_reg_field IC_HS_SCL_LCNT;
	uvm_reg_field RSVD_IC_HS_SCL_LOW_CNT;

	function new(string name = "i2c_IC_HS_SCL_LCNT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_HS_SCL_LCNT)

endclass : ral_reg_i2c_IC_HS_SCL_LCNT


class ral_reg_i2c_IC_INTR_STAT extends uvm_reg;
	...
	function new(string name = "i2c_IC_INTR_STAT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_INTR_STAT)

endclass : ral_reg_i2c_IC_INTR_STAT


class ral_reg_i2c_IC_INTR_MASK extends uvm_reg;
	...
	function new(string name = "i2c_IC_INTR_MASK");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_INTR_MASK)

endclass : ral_reg_i2c_IC_INTR_MASK


class ral_reg_i2c_IC_RAW_INTR_STAT extends uvm_reg;
	...
	function new(string name = "i2c_IC_RAW_INTR_STAT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_RAW_INTR_STAT)

endclass : ral_reg_i2c_IC_RAW_INTR_STAT


class ral_reg_i2c_IC_RX_TL extends uvm_reg;
	rand uvm_reg_field RX_TL;
	uvm_reg_field RSVD_IC_RX_TL;

	function new(string name = "i2c_IC_RX_TL");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_RX_TL)

endclass : ral_reg_i2c_IC_RX_TL


class ral_reg_i2c_IC_TX_TL extends uvm_reg;
	rand uvm_reg_field TX_TL;
	uvm_reg_field RSVD_IC_TX_TL;

	function new(string name = "i2c_IC_TX_TL");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_TX_TL)

endclass : ral_reg_i2c_IC_TX_TL


class ral_reg_i2c_IC_CLR_INTR extends uvm_reg;
	uvm_reg_field CLR_INTR;
	uvm_reg_field RSVD_IC_CLR_INTR;

	function new(string name = "i2c_IC_CLR_INTR");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_INTR)

endclass : ral_reg_i2c_IC_CLR_INTR


class ral_reg_i2c_IC_CLR_RX_UNDER extends uvm_reg;
	uvm_reg_field CLR_RX_UNDER;
	uvm_reg_field RSVD_IC_CLR_RX_UNDER;

	function new(string name = "i2c_IC_CLR_RX_UNDER");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_RX_UNDER)

endclass : ral_reg_i2c_IC_CLR_RX_UNDER


class ral_reg_i2c_IC_CLR_RX_OVER extends uvm_reg;
	uvm_reg_field CLR_RX_OVER;
	uvm_reg_field RSVD_IC_CLR_RX_OVER;

	function new(string name = "i2c_IC_CLR_RX_OVER");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_RX_OVER)

endclass : ral_reg_i2c_IC_CLR_RX_OVER


class ral_reg_i2c_IC_CLR_TX_OVER extends uvm_reg;
	uvm_reg_field CLR_TX_OVER;
	uvm_reg_field RSVD_IC_CLR_TX_OVER;

	function new(string name = "i2c_IC_CLR_TX_OVER");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_TX_OVER)

endclass : ral_reg_i2c_IC_CLR_TX_OVER


class ral_reg_i2c_IC_CLR_RD_REQ extends uvm_reg;
	uvm_reg_field CLR_RD_REQ;
	uvm_reg_field RSVD_IC_CLR_RD_REQ;

	function new(string name = "i2c_IC_CLR_RD_REQ");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_RD_REQ)

endclass : ral_reg_i2c_IC_CLR_RD_REQ


class ral_reg_i2c_IC_CLR_TX_ABRT extends uvm_reg;
	uvm_reg_field CLR_TX_ABRT;
	uvm_reg_field RSVD_IC_CLR_TX_ABRT;

	function new(string name = "i2c_IC_CLR_TX_ABRT");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_TX_ABRT)

endclass : ral_reg_i2c_IC_CLR_TX_ABRT


class ral_reg_i2c_IC_CLR_RX_DONE extends uvm_reg;
	uvm_reg_field CLR_RX_DONE;
	uvm_reg_field RSVD_IC_CLR_RX_DONE;

	function new(string name = "i2c_IC_CLR_RX_DONE");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_RX_DONE)

endclass : ral_reg_i2c_IC_CLR_RX_DONE


class ral_reg_i2c_IC_CLR_ACTIVITY extends uvm_reg;
	uvm_reg_field CLR_ACTIVITY;
	uvm_reg_field RSVD_IC_CLR_ACTIVITY;

	function new(string name = "i2c_IC_CLR_ACTIVITY");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_ACTIVITY)

endclass : ral_reg_i2c_IC_CLR_ACTIVITY


class ral_reg_i2c_IC_CLR_STOP_DET extends uvm_reg;
	uvm_reg_field CLR_STOP_DET;
	uvm_reg_field RSVD_IC_CLR_STOP_DET;

	function new(string name = "i2c_IC_CLR_STOP_DET");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_STOP_DET)

endclass : ral_reg_i2c_IC_CLR_STOP_DET


class ral_reg_i2c_IC_CLR_START_DET extends uvm_reg;
	uvm_reg_field CLR_START_DET;
	uvm_reg_field RSVD_IC_CLR_START_DET;

	function new(string name = "i2c_IC_CLR_START_DET");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_START_DET)

endclass : ral_reg_i2c_IC_CLR_START_DET


class ral_reg_i2c_IC_CLR_GEN_CALL extends uvm_reg;
	uvm_reg_field CLR_GEN_CALL;
	uvm_reg_field RSVD_IC_CLR_GEN_CALL;

	function new(string name = "i2c_IC_CLR_GEN_CALL");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_CLR_GEN_CALL)

endclass : ral_reg_i2c_IC_CLR_GEN_CALL


class ral_reg_i2c_IC_ENABLE extends uvm_reg;
	...
	function new(string name = "i2c_IC_ENABLE");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_ENABLE)

endclass : ral_reg_i2c_IC_ENABLE


class ral_reg_i2c_IC_STATUS extends uvm_reg;
	uvm_reg_field ACTIVITY;
	uvm_reg_field TFNF;
	uvm_reg_field TFE;
	uvm_reg_field RFNE;
	...
	function new(string name = "i2c_IC_STATUS");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
      this.ACTIVITY = uvm_reg_field::type_id::create("ACTIVITY",,get_full_name());
	...
	`uvm_object_utils(ral_reg_i2c_IC_STATUS)

endclass : ral_reg_i2c_IC_STATUS


class ral_reg_i2c_IC_TXFLR extends uvm_reg;
	uvm_reg_field TXFLR;
	uvm_reg_field RSVD_TXFLR;

	function new(string name = "i2c_IC_TXFLR");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_TXFLR)

endclass : ral_reg_i2c_IC_TXFLR


class ral_reg_i2c_IC_RXFLR extends uvm_reg;
	uvm_reg_field RXFLR;
	uvm_reg_field RSVD_RXFLR;

	function new(string name = "i2c_IC_RXFLR");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_RXFLR)

endclass : ral_reg_i2c_IC_RXFLR


class ral_reg_i2c_IC_SDA_HOLD extends uvm_reg;
	rand uvm_reg_field IC_SDA_TX_HOLD;
	rand uvm_reg_field IC_SDA_RX_HOLD;
	uvm_reg_field RSVD_IC_SDA_HOLD;

	function new(string name = "i2c_IC_SDA_HOLD");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_SDA_HOLD)

endclass : ral_reg_i2c_IC_SDA_HOLD


class ral_reg_i2c_IC_TX_ABRT_SOURCE extends uvm_reg;
	...
	function new(string name = "i2c_IC_TX_ABRT_SOURCE");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_TX_ABRT_SOURCE)

endclass : ral_reg_i2c_IC_TX_ABRT_SOURCE


class ral_reg_i2c_IC_SDA_SETUP extends uvm_reg;
	rand uvm_reg_field SDA_SETUP;
	uvm_reg_field RSVD_IC_SDA_SETUP;

	function new(string name = "i2c_IC_SDA_SETUP");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_SDA_SETUP)

endclass : ral_reg_i2c_IC_SDA_SETUP


class ral_reg_i2c_IC_ACK_GENERAL_CALL extends uvm_reg;
	rand uvm_reg_field ACK_GEN_CALL;
	uvm_reg_field RSVD_IC_ACK_GEN_1_31;

	function new(string name = "i2c_IC_ACK_GENERAL_CALL");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_ACK_GENERAL_CALL)

endclass : ral_reg_i2c_IC_ACK_GENERAL_CALL


class ral_reg_i2c_IC_ENABLE_STATUS extends uvm_reg;
	uvm_reg_field IC_EN;
	uvm_reg_field SLV_DISABLED_WHILE_BUSY;
	uvm_reg_field SLV_RX_DATA_LOST;
	uvm_reg_field RSVD_IC_ENABLE_STATUS;

	function new(string name = "i2c_IC_ENABLE_STATUS");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_ENABLE_STATUS)

endclass : ral_reg_i2c_IC_ENABLE_STATUS


class ral_reg_i2c_IC_FS_SPKLEN extends uvm_reg;
	rand uvm_reg_field IC_FS_SPKLEN;
	uvm_reg_field RSVD_IC_FS_SPKLEN;

	function new(string name = "i2c_IC_FS_SPKLEN");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_FS_SPKLEN)

endclass : ral_reg_i2c_IC_FS_SPKLEN


class ral_reg_i2c_IC_HS_SPKLEN extends uvm_reg;
	rand uvm_reg_field IC_HS_SPKLEN;
	uvm_reg_field RSVD_IC_HS_SPKLEN;

	function new(string name = "i2c_IC_HS_SPKLEN");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_HS_SPKLEN)

endclass : ral_reg_i2c_IC_HS_SPKLEN


class ral_reg_i2c_REG_TIMEOUT_RST extends uvm_reg;
	rand uvm_reg_field REG_TIMEOUT_RST_rw;
	uvm_reg_field RSVD_REG_TIMEOUT_RST;

	function new(string name = "i2c_REG_TIMEOUT_RST");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_REG_TIMEOUT_RST)

endclass : ral_reg_i2c_REG_TIMEOUT_RST


class ral_reg_i2c_IC_COMP_PARAM_1 extends uvm_reg;
	...
	function new(string name = "i2c_IC_COMP_PARAM_1");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_COMP_PARAM_1)

endclass : ral_reg_i2c_IC_COMP_PARAM_1


class ral_reg_i2c_IC_COMP_VERSION extends uvm_reg;
	uvm_reg_field IC_COMP_VERSION;

	function new(string name = "i2c_IC_COMP_VERSION");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_COMP_VERSION)

endclass : ral_reg_i2c_IC_COMP_VERSION


class ral_reg_i2c_IC_COMP_TYPE extends uvm_reg;
	uvm_reg_field IC_COMP_TYPE;

	function new(string name = "i2c_IC_COMP_TYPE");
		super.new(name, 32,build_coverage(UVM_NO_COVERAGE));
	endfunction: new
   virtual function void build();
	...
	`uvm_object_utils(ral_reg_i2c_IC_COMP_TYPE)

endclass : ral_reg_i2c_IC_COMP_TYPE


class ral_block_i2c extends uvm_reg_block;
	rand ral_reg_i2c_IC_CON IC_CON;
	rand ral_reg_i2c_IC_TAR IC_TAR;
	rand ral_reg_i2c_IC_SAR IC_SAR;
	rand ral_reg_i2c_IC_HS_MADDR IC_HS_MADDR;
	rand ral_reg_i2c_IC_DATA_CMD IC_DATA_CMD;
	rand ral_reg_i2c_IC_SS_SCL_HCNT IC_SS_SCL_HCNT;
	rand ral_reg_i2c_IC_SS_SCL_LCNT IC_SS_SCL_LCNT;
	rand ral_reg_i2c_IC_FS_SCL_HCNT IC_FS_SCL_HCNT;
	rand ral_reg_i2c_IC_FS_SCL_LCNT IC_FS_SCL_LCNT;
	rand ral_reg_i2c_IC_HS_SCL_HCNT IC_HS_SCL_HCNT;
	rand ral_reg_i2c_IC_HS_SCL_LCNT IC_HS_SCL_LCNT;
	rand ral_reg_i2c_IC_INTR_STAT IC_INTR_STAT;
	rand ral_reg_i2c_IC_INTR_MASK IC_INTR_MASK;
	rand ral_reg_i2c_IC_RAW_INTR_STAT IC_RAW_INTR_STAT;
	rand ral_reg_i2c_IC_RX_TL IC_RX_TL;
	rand ral_reg_i2c_IC_TX_TL IC_TX_TL;
	rand ral_reg_i2c_IC_CLR_INTR IC_CLR_INTR;
	rand ral_reg_i2c_IC_CLR_RX_UNDER IC_CLR_RX_UNDER;
	rand ral_reg_i2c_IC_CLR_RX_OVER IC_CLR_RX_OVER;
	rand ral_reg_i2c_IC_CLR_TX_OVER IC_CLR_TX_OVER;
	rand ral_reg_i2c_IC_CLR_RD_REQ IC_CLR_RD_REQ;
	rand ral_reg_i2c_IC_CLR_TX_ABRT IC_CLR_TX_ABRT;
	rand ral_reg_i2c_IC_CLR_RX_DONE IC_CLR_RX_DONE;
	rand ral_reg_i2c_IC_CLR_ACTIVITY IC_CLR_ACTIVITY;
	rand ral_reg_i2c_IC_CLR_STOP_DET IC_CLR_STOP_DET;
	rand ral_reg_i2c_IC_CLR_START_DET IC_CLR_START_DET;
	rand ral_reg_i2c_IC_CLR_GEN_CALL IC_CLR_GEN_CALL;
	rand ral_reg_i2c_IC_ENABLE IC_ENABLE;
	rand ral_reg_i2c_IC_STATUS IC_STATUS;
	rand ral_reg_i2c_IC_TXFLR IC_TXFLR;
	rand ral_reg_i2c_IC_RXFLR IC_RXFLR;
	rand ral_reg_i2c_IC_SDA_HOLD IC_SDA_HOLD;
	rand ral_reg_i2c_IC_TX_ABRT_SOURCE IC_TX_ABRT_SOURCE;
	rand ral_reg_i2c_IC_SDA_SETUP IC_SDA_SETUP;
	rand ral_reg_i2c_IC_ACK_GENERAL_CALL IC_ACK_GENERAL_CALL;
	rand ral_reg_i2c_IC_ENABLE_STATUS IC_ENABLE_STATUS;
	rand ral_reg_i2c_IC_FS_SPKLEN IC_FS_SPKLEN;
	rand ral_reg_i2c_IC_HS_SPKLEN IC_HS_SPKLEN;
	rand ral_reg_i2c_REG_TIMEOUT_RST REG_TIMEOUT_RST;
	rand ral_reg_i2c_IC_COMP_PARAM_1 IC_COMP_PARAM_1;
	rand ral_reg_i2c_IC_COMP_VERSION IC_COMP_VERSION;
	rand ral_reg_i2c_IC_COMP_TYPE IC_COMP_TYPE;
...
endgroup
   ...
   virtual function void build();
      ...
      this.IC_CON = ral_reg_i2c_IC_CON::type_id::create("IC_CON",,get_full_name());
      ...
      this.IC_TAR = ral_reg_i2c_IC_TAR::type_id::create("IC_TAR",,get_full_name());
      ...
      this.IC_SAR = ral_reg_i2c_IC_SAR::type_id::create("IC_SAR",,get_full_name());
      ...
      this.IC_HS_MADDR = ral_reg_i2c_IC_HS_MADDR::type_id::create("IC_HS_MADDR",,get_full_name());
      ...
      this.IC_DATA_CMD = ral_reg_i2c_IC_DATA_CMD::type_id::create("IC_DATA_CMD",,get_full_name());
      ...
      this.IC_SS_SCL_HCNT = ral_reg_i2c_IC_SS_SCL_HCNT::type_id::create("IC_SS_SCL_HCNT",,get_full_name());
      ...
      this.IC_SS_SCL_LCNT = ral_reg_i2c_IC_SS_SCL_LCNT::type_id::create("IC_SS_SCL_LCNT",,get_full_name());
      ...
      this.IC_FS_SCL_HCNT = ral_reg_i2c_IC_FS_SCL_HCNT::type_id::create("IC_FS_SCL_HCNT",,get_full_name());
      ...
      this.IC_FS_SCL_LCNT = ral_reg_i2c_IC_FS_SCL_LCNT::type_id::create("IC_FS_SCL_LCNT",,get_full_name());
      ...
      this.IC_HS_SCL_HCNT = ral_reg_i2c_IC_HS_SCL_HCNT::type_id::create("IC_HS_SCL_HCNT",,get_full_name());
      ...
      this.IC_HS_SCL_LCNT = ral_reg_i2c_IC_HS_SCL_LCNT::type_id::create("IC_HS_SCL_LCNT",,get_full_name());
      ...
      this.IC_INTR_STAT = ral_reg_i2c_IC_INTR_STAT::type_id::create("IC_INTR_STAT",,get_full_name());
      ...
      this.IC_INTR_MASK = ral_reg_i2c_IC_INTR_MASK::type_id::create("IC_INTR_MASK",,get_full_name());
      ...
      this.IC_RAW_INTR_STAT = ral_reg_i2c_IC_RAW_INTR_STAT::type_id::create("IC_RAW_INTR_STAT",,get_full_name());
      ...
      this.IC_RX_TL = ral_reg_i2c_IC_RX_TL::type_id::create("IC_RX_TL",,get_full_name());
      ...
      this.IC_TX_TL = ral_reg_i2c_IC_TX_TL::type_id::create("IC_TX_TL",,get_full_name());
      ...
      this.IC_CLR_INTR = ral_reg_i2c_IC_CLR_INTR::type_id::create("IC_CLR_INTR",,get_full_name());
      ...
      this.IC_CLR_RX_UNDER = ral_reg_i2c_IC_CLR_RX_UNDER::type_id::create("IC_CLR_RX_UNDER",,get_full_name());
      ...
      this.IC_CLR_RX_OVER = ral_reg_i2c_IC_CLR_RX_OVER::type_id::create("IC_CLR_RX_OVER",,get_full_name());
      ...
      this.IC_CLR_TX_OVER = ral_reg_i2c_IC_CLR_TX_OVER::type_id::create("IC_CLR_TX_OVER",,get_full_name());
      ...
      this.IC_CLR_RD_REQ = ral_reg_i2c_IC_CLR_RD_REQ::type_id::create("IC_CLR_RD_REQ",,get_full_name());
      ...
      this.IC_CLR_TX_ABRT = ral_reg_i2c_IC_CLR_TX_ABRT::type_id::create("IC_CLR_TX_ABRT",,get_full_name());
      ...
      this.IC_CLR_RX_DONE = ral_reg_i2c_IC_CLR_RX_DONE::type_id::create("IC_CLR_RX_DONE",,get_full_name());
      ...
      this.IC_CLR_ACTIVITY = ral_reg_i2c_IC_CLR_ACTIVITY::type_id::create("IC_CLR_ACTIVITY",,get_full_name());
      ...
      this.IC_CLR_STOP_DET = ral_reg_i2c_IC_CLR_STOP_DET::type_id::create("IC_CLR_STOP_DET",,get_full_name());
      ...
      this.IC_CLR_START_DET = ral_reg_i2c_IC_CLR_START_DET::type_id::create("IC_CLR_START_DET",,get_full_name());
      ...
      this.IC_CLR_GEN_CALL = ral_reg_i2c_IC_CLR_GEN_CALL::type_id::create("IC_CLR_GEN_CALL",,get_full_name());
      ...
      this.IC_ENABLE = ral_reg_i2c_IC_ENABLE::type_id::create("IC_ENABLE",,get_full_name());
      ...
      this.IC_STATUS = ral_reg_i2c_IC_STATUS::type_id::create("IC_STATUS",,get_full_name());
      ...
      this.IC_TXFLR = ral_reg_i2c_IC_TXFLR::type_id::create("IC_TXFLR",,get_full_name());
      ...
      this.IC_RXFLR = ral_reg_i2c_IC_RXFLR::type_id::create("IC_RXFLR",,get_full_name());
      ...
      this.IC_SDA_HOLD = ral_reg_i2c_IC_SDA_HOLD::type_id::create("IC_SDA_HOLD",,get_full_name());
      ...
      this.IC_TX_ABRT_SOURCE = ral_reg_i2c_IC_TX_ABRT_SOURCE::type_id::create("IC_TX_ABRT_SOURCE",,get_full_name());
      ...
      this.IC_SDA_SETUP = ral_reg_i2c_IC_SDA_SETUP::type_id::create("IC_SDA_SETUP",,get_full_name());
      ...
      this.IC_ACK_GENERAL_CALL = ral_reg_i2c_IC_ACK_GENERAL_CALL::type_id::create("IC_ACK_GENERAL_CALL",,get_full_name());
      ...
      this.IC_ENABLE_STATUS = ral_reg_i2c_IC_ENABLE_STATUS::type_id::create("IC_ENABLE_STATUS",,get_full_name());
      ...
      this.IC_FS_SPKLEN = ral_reg_i2c_IC_FS_SPKLEN::type_id::create("IC_FS_SPKLEN",,get_full_name());
      ...
      this.IC_HS_SPKLEN = ral_reg_i2c_IC_HS_SPKLEN::type_id::create("IC_HS_SPKLEN",,get_full_name());
      ...
      this.REG_TIMEOUT_RST = ral_reg_i2c_REG_TIMEOUT_RST::type_id::create("REG_TIMEOUT_RST",,get_full_name());
      ...
      this.IC_COMP_PARAM_1 = ral_reg_i2c_IC_COMP_PARAM_1::type_id::create("IC_COMP_PARAM_1",,get_full_name());
      ...
      this.IC_COMP_VERSION = ral_reg_i2c_IC_COMP_VERSION::type_id::create("IC_COMP_VERSION",,get_full_name());
      ...
      this.IC_COMP_TYPE = ral_reg_i2c_IC_COMP_TYPE::type_id::create("IC_COMP_TYPE",,get_full_name());
...
//  this.IC_DATA_CMD.add_hdl_path_slice("rx_pop_data", 0, 32);
	...
	`uvm_object_utils(ral_block_i2c)
