`ifndef I2C_QUICK_REG_ACCESS_VIRT_SEQ_SV
`define I2C_QUICK_REG_ACCESS_VIRT_SEQ_SV
class i2c_quick_reg_access_virt_seq extends i2c_base_virtual_sequence;

  `uvm_object_utils(i2c_quick_reg_access_virt_seq)

  function new (string name = "i2c_quick_reg_access_virt_seq");
    super.new(name);
  endfunction
  ...
  virtual task body();
    ...
    `uvm_info(get_type_name(), "=====================FINISHED=====================TEST CASE PASSED", UVM_LOW)
  endtask

endclass
`endif // I2C_QUICK_REG_ACCESS_VIRT_SEQ_SV
