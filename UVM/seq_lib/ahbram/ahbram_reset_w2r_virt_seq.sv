`ifndef AHBRAM_RESET_W2R_VIRT_SEQ_SV
`define AHBRAM_RESET_W2R_VIRT_SEQ_SV

class ahbram_reset_w2r_virt_seq extends ahbram_base_virtual_sequence;
  `uvm_object_utils(ahbram_reset_w2r_virt_seq)

  function new (string name = "ahbram_reset_w2r_virt_seq");
    super.new(name);
  endfunction
