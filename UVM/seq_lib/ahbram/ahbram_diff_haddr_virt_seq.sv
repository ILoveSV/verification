`ifndef AHBRAM_DIFF_HADDR_VIRT_SEQ_SV
`define AHBRAM_DIFF_HADDR_VIRT_SEQ_SV

class ahbram_diff_haddr_virt_seq extends ahbram_base_virtual_sequence;
  `uvm_object_utils(ahbram_diff_haddr_virt_seq)

  function new (string name = "ahbram_diff_haddr_virt_seq");
    super.new(name);
  endfunction
