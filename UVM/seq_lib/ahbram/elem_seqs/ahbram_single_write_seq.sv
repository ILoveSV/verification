`ifndef AHBRAM_SINGLE_WRITE_SEQ_SV
`define AHBRAM_SINGLE_WRITE_SEQ_SV

class ahbram_single_write_seq extends ahbram_base_element_sequence;
  rand bit [31:0]      addr;
  rand bit [31:0]      data;
  ...
  `uvm_object_utils(ahbram_single_write_seq)
  function new (string name = "ahbram_single_write_seq");
    super.new(name);
  endfunction
  virtual task body();
