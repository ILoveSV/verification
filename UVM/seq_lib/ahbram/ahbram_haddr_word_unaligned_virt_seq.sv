`ifndef AHBRAM_HADDR_WORD_UNALIGNED_VIRT_SEQ_SV
`define AHBRAM_HADDR_WORD_UNALIGNED_VIRT_SEQ_SV

class ahbram_haddr_word_unaligned_virt_seq extends ahbram_base_virtual_sequence;
  `uvm_object_utils(ahbram_haddr_word_unaligned_virt_seq)

  function new (string name = "ahbram_haddr_word_unaligned_virt_seq");
    super.new(name);
  endfunction
