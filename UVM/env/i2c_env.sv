...
class i2c_env extends uvm_env;
  ...
  // top scoreboard
  i2c_master_scoreboard sbd_mst;

  // top virtual sequencer
  i2c_virtual_sequencer sqr;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if(!uvm_config_db#(virtual i2c_if)::get(this,"","vif", vif)) begin
      `uvm_error("GETVIF","cannot get i2c_if handle from config DB")
    end
    cfg.vif = vif;
    ...
    cfg.rgm = rgm;
    uvm_config_db#(ral_block_i2c)::set(this,"*","rgm", rgm);
    ...
    uvm_config_db#(i2c_config)::set(this, "sbd_mst", "cfg", cfg);
    sbd_mst = new("sbd_mst", this);

    uvm_config_db#(i2c_config)::set(this, "sqr", "cfg", cfg);
    sqr = new("sqr", this);

    uvm_config_db#(i2c_config)::set(this, "cgm", "cfg", cfg);
    cgm = new("cgm", this);
