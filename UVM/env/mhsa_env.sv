...
class mhsa_env extends uvm_env;
  ...
  virtual function void build_phase(uvm_phase phase);
   ...
   if(!uvm_config_db#(mhsa_cfg)::get(this,"","APB_ENV_CFG",w_cfg))begin
     `uvm_fatal("ENV_CFG NOT FOUND ERROR",$psprintf("mhsa_cfg not found"))
   end
   uvm_config_db#(mhsa_mstr_agent_config)::set(null,"*","APB_MSTR_AGNT_CFG",w_cfg.mhsa_mstr_agnt_cfg);
//   uvm_config_db#(mhsa_config)::set(this, "virt_sqr", "cfg", cfg);
